---
title: "Gapminder Amazingness"
author: "Nicole Carlson & Melinda Higgins"
...
The mean life expectancy is `r round(mean(gapminder$lifeExp), digits=2)` years.  Standard deviation = `r round(sd(gapminder$lifeExp), digits=2)`.
The median life expectancy is `r round(median(gapminder$lifeExp), digits=2)` years.
Sample size for this dataset was `r length(gapminder)`.
...
See above the 4 requested changes made to the Rmd file.  
To view the Github repository for this HW 1, go to this link: [https://github.com/nicolecarlson/N741Homework1-1]
